...
return [
    'BE' => [
        ...
        'installToolPassword' => '$pbkdf2-sha256$25000$uFz84BY7rlp/XsJ4uMVmxA$ZOCP9crnqkAUZ1bNqfT38FyS1O/rPrYV/L2b89M208Q',
    ...
    'DB' => [
        'Connections' => [
            'Default' => [
                'charset' => 'utf8',
                'dbname' => 'logbook_typo3',
                'driver' => 'mysqli',
                'host' => 'db',
                'password' => 'logbook-root',
                'port' => 3306,
                'user' => 'root',
            ],
        ],
    ...
    'SYS' => [
        ...
        'encryptionKey' => 'cb306555f99b5c63b12f5e6f232567a1cced63ee5a8240259e1f2e0a423e75886f253d7fa1a4da867f72f5a6a3db072c',
